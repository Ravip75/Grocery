...
import { listProducts, saveProduct,deleteProdcut } from '../actions/productAction';
        ...
        <form onSubmit={submitHandler}>
            <ul className="form-container">
               ...
               <li>
                   ...
                   <input type="text" name="categoty" value={category} id="category" onChange={(e)=>setCategory(e.target.value)}></input>
               </li>
